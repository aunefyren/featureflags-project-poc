...
text += "<div class='item'>";
    ...
    text += "<div class='answer'>" + features.feature[2].name + "</div>"
text += "</div>";

text += "<div class='item'>";
    text += "<div class='title'>Error: </div>";
    text += "<div class='answer'>" + features.feature[2].error + "</div>"
text += "</div>";

text += "<div class='item'>";
    text += "<div class='title'>Message: </div>";
    text += "<div class='text'>" + features.feature[2].message + "</div>"
text += "</div>";

text += "<div class='item'>";
    text += "<div class='title'>Status: </div>";
    text += "<div class='answer'>" + features.feature[2].status;
...
text += "<div class='item'>";
    ...
    text += "<div class='text'>" + features.feature[2].comment + "</div>"
text += "</div>";
